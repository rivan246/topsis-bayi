...
<body>
	...
	<header id="header">
		<div class="container clearfix">
			<div id="logo-wrap">
				<h1 id="logo"><a href="index.php"><img src="images/baby.png" width="100" 
     			height="100" alt=""></a></h1>
			</div>
				...
				<nav id="nav">
					<ul class="sf-menu">
						...
						<?php if($user_role == 'admin' || $user_role == 'petugas'): ?>
							<li><a href="list-desa.php">Desa</a>
								<ul>
									<li><a href="list-desa.php">List Desa</a></li>
									<li><a href="tambah-desa.php">Tambah Desa</a></li>
								</ul>
							</li>
						<?php endif; ?>
						<li><a href="ranking-topsis.php">Ranking Topsis</a>
							<!-- <ul>
