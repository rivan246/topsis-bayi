...
if(isset($_POST['submit'])):	
	...
	// Validasi
	if(!$no_kalung) {
		$errors[] = 'Nomor Desa tidak boleh kosong';
	}	
	...
	if(empty($errors)):
		...
		$sukses = "Desa no. <strong>{$no_kalung}</strong> berhasil dimasukkan.";
		...
		redirect_to('list-desa.php?status=sukses-baru');		
	...
	<div class="container clearfix">
		...
		<div class="main-content the-content">
			...
			<?php endif; ?>			
				...
				<form action="tambah-desa.php" method="post">
					<div class="field-wrap clearfix">					
						<label>Nomor <span class="red">*</span></label>
					...
					<div class="field-wrap clearfix">
						<button type="submit" name="submit" value="submit" class="button">Tambah Desa</button>
					</div>
				</form>
